const config = {
    HEO_HOME_BANNER_ENABLE: true, // 是否启用首页横幅
    "时间": '2025-01-01',          // 建站日期，用于计算网站运行的第几天
    "注意事项": [                  // 首页顶部通知条滚动内容，如不需要可以留空 []
        "欢迎访问我们的网站！",
        "新年快乐！"
    ]
};
  ...
  // 首页顶部通知条滚动内容，如不需要可以留空 []
   注意事项 : [
     {  标题 : '欢迎来到拾光分享站' , 乌拉圭网址 : 'https://qshare.cc'  } ,
       {    标题 : '探索更多实用资源' , 乌拉圭网址 : 'https://qshare.cc'    }
     ] ,

  // 英雄区左右侧组件颠倒位置
     相反的 : 假的 ,
  // 博客主体区左右侧组件颠倒位置
     HEO_HERO_BODY_REVERSE : 假的 ,
